...
public class ComputeShaderThreadTest : MonoBehaviour
{
    ...
    protected Vector2Int _threadCount = new Vector2Int(8, 1);
    ...
    protected int _property_shaderTex = Shader.PropertyToID("_MainTex");
    ...
    protected virtual void Update()
    {
        ...
        _threadGroups = _threadCount;
        if (computeShader) computeShader.Dispatch(_kernelIndex, 4, 512, 1);
